...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Image('logoinudi.png', 270, 5, 20); //logo de la empresa,moverDerecha,moverAbajo,tamañoIMG
...
if ($empleado == "todos") {
   ...
   date_format(asistencia.entrada, '%m-%d-%y %H:%i:%s') as 'salida', 
...
$pdf->Output('Reporte_asistencia.pdf', 'I');//nombreDescarga, Visor(I->visualizar - D->descargar)
