...
class PDF extends FPDF
{
   ...
   function Header()
   {
      ...
      $this->Image('logoinudi.png', 180, 5, 40); //logo de la empresa,moverDerecha,moverAbajo,tamañoIMG
...
$pdf->Output('Reporte_usuario.pdf', 'I');//nombreDescarga, Visor(I->visualizar - D->descargar)
